                    ...
                    <form action="${pageContext.request.contextPath}/saveEmpInfo" method="post" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="ename" type="text" id="ename" value="${emp.ename}"
                                           class="form-control input-sm">
                                </div>
                                <label class="col-sm-2 col-sm-offset-1 control-label">用户名</label>
                                <div class="col-sm-3">
                                    <input name="username" type="text" id="username" value="${emp.username}"
                                           class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="pnum" id="pnum" value="${emp.pnum}" type="text" class="form-control input-sm">
                                </div>
                                <label class="col-sm-2 col-sm-offset-1 control-label">联系电话</label>
                                <div class="col-sm-3">
                                    <input name="telephone" id="tel" value="${emp.telephone}" type="text"
                                           class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <!--时间控件的id都不能改-->
                                    <input name="hiredate" id="start" value="${emp.hiredate}"
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input name="eage" type="text" value="${emp.eage}" class="form-control input-sm">
                                    </div>
                                    <label class="col-sm-2 col-sm-offset-1 control-label">角色</label>
                                    <div class="col-sm-3">
                                        <select name="rolefk" id="role" class="form-control">
                                                    <option value="${emp.dept.deptno==1}">开发部</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="remark" value="${emp.remark}" class="form-control"></textarea>
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <a href="${pageContext.request.contextPath}/showAllEmp" class="btn btn-white"><i
