...
<form name="form2" id="form15" action="${pageContext.request.contextPath}/sendEmail" method="post" enctype="multipart/form-data">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="rep" name="receiveAccount">
             <option value="15169115573@163.com">张三</option>
		</select></td>
</tr>
<tr >
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<textarea rows=15 cols=130 name="contnet"></textarea></td>
</tr>
